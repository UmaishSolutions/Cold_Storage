frappe.query_reports["Cold Storage Stock Flow Sankey"] = {
	...
	filters: [
		...
		{
			fieldname: "top_n_groups",
			label: __("Top Item Groups"),
			fieldtype: "Int",
			default: 8,
			description: __("Top item groups included in Sankey payload."),
		},
	],
};
